...
//                        // Thực hiện xác thực người dùng và đặt thông tin vào SecurityContextHolder
//                        SecurityContextHolder.getContext().setAuthentication(authenticationManager.authenticate(auth));
                    }
                }
            } catch (Exception e) {
                log.error("Error do filter once per request, path {}, error: {}", request.getRequestURI(), e.getMessage());
