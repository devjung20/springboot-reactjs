...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductService productService, RabbitTemplate rabbitTemplate, DirectExchange exchange) {
...
//    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> createProduct(@Valid @RequestBody Product product,
        ...
        try {
            ...
            if (productCreate != null) {
                // Gửi thông điệp tới RabbitMQ khi tạo mới sản phẩm thành công
                rabbitTemplate.convertAndSend(exchange.getName(), "product.create", product);
    ...
    public ResponseEntity<?> updateProduct(@PathVariable("id") int id,
        ...
        try {
            ...
            rabbitTemplate.convertAndSend(exchange.getName(), "product.update", product);
    ...
    public ResponseEntity<?> deleteProduct(@PathVariable("id") int id, Authentication authentication) {
        try {
            ...
            rabbitTemplate.convertAndSend(exchange.getName(), "product.delete", id);
